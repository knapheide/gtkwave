...
#define WAVE_TCLCB_TRACE_ADDED "gtkwave::cbTraceAdded"
#define WAVE_TCLCB_TRACE_ADDED_FLAGS WAVE_TCLCB_FLAGS_NONE
#define WAVE_TCLCB_TRACE_ADDED_INIT ""
...
#define WAVE_TCLCB_MACRO_EXPANSION \
    WAVE_TCLCB_M(WAVE_TCLCB_ERROR, WAVE_TCLCB_ERROR_FLAGS, WAVE_TCLCB_ERROR_INIT), \
        ...
        WAVE_TCLCB_M(WAVE_TCLCB_TRACE_ADDED, \
                     WAVE_TCLCB_TRACE_ADDED_FLAGS, \
                     WAVE_TCLCB_TRACE_ADDED_INIT), \
